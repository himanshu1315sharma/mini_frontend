...
/*LIN 149 TO 152               <Image onClick={async () =>{ setImg1("https://i.postimg.cc/fTHvrWmD/1.jpg")}} src="https://i.postimg.cc/7YzQdxPS/1.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
*/
 ...
 export const Product1 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
  ...
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg1(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg1(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              ...
              <Image onClick={handleClick1} src="https://i.postimg.cc/7YzQdxPS/1.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/dVmNQ4y1/2.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/N0dNmFbv/3.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={() => setImg1("https://i.postimg.cc/Jn5YhPvx/1.jpg")} src="https://i.postimg.cc/kMH7wCHb/25.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/xjJsN0zB/4.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/SQBgWwLR/5.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3}src="https://i.postimg.cc/NMVpCnWN/6.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
console.log("hello");
    ...
    setImg3(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg3(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/B6tmg3wL/7.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/G3V5XBRc/8.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/L6jNvNvT/9.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
export const Product4 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    setImg4(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg4(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg4(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/MGQr5K0T/10.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/zGMcTRg6/11.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/j2Z82WT8/12.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
export const Product5 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    setImg5(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg5(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg5(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              ...
              <Image onClick={handleClick1} src="https://i.postimg.cc/bJ0VXCBf/13.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2}  src="https://i.postimg.cc/7hxsq3FG/14.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} /> 
              <Image onClick={handleClick3} src="https://i.postimg.cc/MpxtLVF8/19.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
export const Product6 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    setImg6(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg6(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg6(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/nVkS0Wmv/16.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/c4k9N8XC/17.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/ZK57gLPX/18.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
export const Product7 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    setImg7(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg7(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg7(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/MpxtLVF8/19.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/kgcwPG0R/20.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/g02szdpS/21.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
...
export const Product8 = () => {
  ...
  const handleClick1 = async (e) => {
    ...
    setImg8(res.data.img1);
    
  };
  const handleClick2 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg8(res.data.img2);
  };
  const handleClick3 = async (e) => {
    e.preventDefault();
    const res = await axios.get("http://localhost:5000/api/products/find/" + search);
    setImg8(res.data.img3);
  };
  return (
    <Container>
      <Navbar />
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              <FilterTitle>Clothes</FilterTitle>
              <Image onClick={handleClick1} src="https://i.postimg.cc/JhYqtg41/22.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick2} src="https://i.postimg.cc/gJwKhDn3/23.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
              <Image onClick={handleClick3} src="https://i.postimg.cc/5yLq7250/24.jpg" style={{ "height": "50px", "width": "50px",  "background-position": "center", "object-fit": "contain","border-radius":"50%" }} />
